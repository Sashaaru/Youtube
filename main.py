...
youtube = googleapiclient.discovery.build("youtube", "v3", developerKey="AIzaSyCsq_MlzsfC5KUVja45DUCcQRov8LzyBUo")
...
def get_comments(video_ids):
    ...
    for video in video_ids:
        try:
            ...
            # Handle the error, you can display a message or simply continue to the next video
            print(f"An error occurred for video {video}: {e}")
